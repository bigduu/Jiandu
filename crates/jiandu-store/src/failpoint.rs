...
pub enum PersistenceBoundary {
    ...
    TombstoneNamespacePrepared,
    TombstoneTempWritten,
    TombstoneTempSynced,
    TombstoneTempDirectorySynced,
    MetadataTempWritten,
    MetadataTempSynced,
    ...
    BackupMetadataTempWritten,
    BackupMetadataTempSynced,
    BackupMetadataTempDirectorySynced,
    RecordRenamed,
    RecordDirectorySynced,
    TombstonePublished,
    TombstoneDirectorySynced,
    RecordRenamedForForget,
    ForgetRecordDirectorySynced,
    ForgottenBodyErased,
    ForgottenBodySynced,
    ...
    BackupMetadataPublished,
    BackupMetadataDirectorySynced,
    MetadataRenamed,
    ...
    RecoveryTombstoneSynced,
    RecoveryForgetWitnessDirectorySynced,
    RecoveryForgottenBodyErased,
    RecoveryForgottenBodySynced,
    ...
    RecoveryBackupMetadataDirectorySynced,
    ...
    MigrationPreviousMetadataRemoved,
    MigrationPreviousMetadataDirectorySynced,
...
impl PersistenceBoundary {
    ...
    pub const ALL: &'static [Self] = &[
        ...
        Self::MutationAuditTempSynced,
        Self::MutationAuditTempDirectorySynced,
        Self::BackupMetadataTempWritten,
        Self::BackupMetadataTempSynced,
        Self::BackupMetadataTempDirectorySynced,
        Self::RecordRenamed,
        Self::RecordDirectorySynced,
        Self::TombstonePublished,
        Self::TombstoneDirectorySynced,
        ...
        Self::MutationAuditPublished,
        Self::MutationAuditDirectorySynced,
        Self::BackupMetadataPublished,
        Self::BackupMetadataDirectorySynced,
        Self::MetadataRenamed,
        Self::MetadataDirectorySynced,
        ...
        Self::RecoveryTombstoneSynced,
        Self::RecoveryForgetWitnessDirectorySynced,
        Self::RecoveryForgottenBodyErased,
        Self::RecoveryForgottenBodySynced,
        ...
        Self::RecoveryBackupMetadataDirectorySynced,
        ...
        Self::MigrationPreviousMetadataRemoved,
        Self::MigrationPreviousMetadataDirectorySynced,
